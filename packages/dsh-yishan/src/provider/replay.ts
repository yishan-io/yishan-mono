...
export function isDshTestReplayEnabled(environment: NodeJS.ProcessEnv = process.env): boolean {
...
export function installDshTestReplayAdapter(context: Context): void {
