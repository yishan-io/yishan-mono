...
// personaSummarizer extracts and merges developer persona from session
// transcripts. It is the LLM-backed half of the persona workflow; the daily
// batch orchestration (personaService) lives in persona.go.
