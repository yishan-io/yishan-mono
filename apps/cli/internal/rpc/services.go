...
type LocalTaskService interface {
	...
	ListTagCatalog(ctx context.Context) (any, error)
	UpdateTagColor(ctx context.Context, req LocalTaskUpdateTagColorParams) (any, error)
	CreateTag(ctx context.Context, req LocalTaskCreateTagParams) (any, error)
	RenameTag(ctx context.Context, req LocalTaskRenameTagParams) (any, error)
	DeleteTag(ctx context.Context, req LocalTaskDeleteTagParams) (any, error)
