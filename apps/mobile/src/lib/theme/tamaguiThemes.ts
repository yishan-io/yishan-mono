...
import { COLOR_PRIMITIVES, type DesignTokenThemeMode, SEMANTIC_COLOR_TOKENS } from "@yishan/design-tokens/v1";

/**
 * Owns the mobile overlay that maps shared design-token semantics onto Tamagui theme slots.
 * Shared token truth stays in `@yishan/design-tokens`; mobile-only slot mapping lives here.
 */
