 ...
 */
export const COMPLETED_PHASES = ["P16", "D1"] as const;
...
export const KNOWN_VIOLATIONS: KnownViolation[] = [
  ...
  { rule: "R14-cross-domain-deep", file: "domains/agent/commands/voiceTranscriptionCommands.ts", phase: "D12" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/agent/ui/chat/useVoiceRecording.ts", phase: "D12" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/node/commands/nodeCommands.ts", phase: "D5" },
  { rule: "R14-cross-domain-deep", file: "domains/notification/commands/notificationCommands.ts", phase: "D13" },
  { rule: "R14-cross-domain-deep", file: "domains/notification/events/notificationEventHandlers.ts", phase: "D13" },
  { rule: "R14-cross-domain-deep", file: "domains/organization/commands/orgCommands.ts", phase: "D4" },
  { rule: "R14-cross-domain-deep", file: "domains/overview/commands/overviewCommands.ts", phase: "D14" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/project/commands/projectCommands.ts", phase: "D6" },
  { rule: "R14-cross-domain-deep", file: "domains/project/ui/ProjectListMenus.tsx", phase: "D6" },
  { rule: "R14-cross-domain-deep", file: "domains/project/ui/ProjectListView.tsx", phase: "D6" },
  { rule: "R14-cross-domain-deep", file: "domains/project/ui/useProjectListFoldState.ts", phase: "D6" },
  { rule: "R14-cross-domain-deep", file: "domains/project/ui/useProjectListTreeData.ts", phase: "D6" },
  { rule: "R14-cross-domain-deep", file: "domains/scheduled-job/commands/scheduledJobCommands.ts", phase: "D15" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/scheduled-job/ui/ScheduledJobDetailView.tsx", phase: "D15" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/settings/ui/AccountSettingsView.tsx", phase: "D16" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/settings/ui/LanguageSettingsView.tsx", phase: "D16" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/settings/ui/daemon/daemonSettings/closeTerminalTabsForDaemonRestart.ts", phase: "D16" },
  { rule: "R14-cross-domain-deep", file: "domains/settings/ui/daemon/daemonSettings/useDaemonConnectionState.ts", phase: "D16" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/workspace/commands/localFolderCommands.ts", phase: "D8" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/workspace/commands/workspaceWarmupCommand.ts", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/events/workspaceEventHandlers.ts", phase: "D8" },
  ...
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/LeftPane/LeftPaneResourceUsageControl.tsx", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/LeftPane/createWorkspaceDialog/ProjectAndSourceBranchSection.tsx", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/LeftPane/createWorkspaceDialog/TaskRunSection.tsx", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/LeftPane/createWorkspaceDialog/useAgentModels.ts", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/LeftPane/useCreateWorkspaceDialogState.ts", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/LeftPane/useWorkspaceInfoHover.ts", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/WorkspaceResourceUsageControl.tsx", phase: "D8" },
  { rule: "R14-cross-domain-deep", file: "domains/workspace/ui/workspaceNotificationUtils.ts", phase: "D8" },
  ...
  { rule: "R15-app-from-domain", file: "domains/git/ui/pullRequestTab/PullRequestDeploymentsSection.tsx", phase: "D10" },
  ...
  { rule: "R15-app-from-domain", file: "domains/project/commands/projectCommands.ts", phase: "D6" },
  { rule: "R15-app-from-domain", file: "domains/project/ui/CreateProjectFormView.tsx", phase: "D6" },
  { rule: "R15-app-from-domain", file: "domains/project/ui/ProjectConfigDialogView.tsx", phase: "D6" },
  { rule: "R15-app-from-domain", file: "domains/project/ui/ProjectFilterPopoverView.tsx", phase: "D6" },
  { rule: "R15-app-from-domain", file: "domains/project/ui/ProjectListView.tsx", phase: "D6" },
  { rule: "R15-app-from-domain", file: "domains/project/ui/useProjectConfigActions.ts", phase: "D6" },
  ...
  { rule: "R15-app-from-domain", file: "domains/settings/ui/daemon/daemonSettings/DaemonConnectionSection.tsx", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/daemon/daemonSettings/DaemonRelaySection.tsx", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/daemon/daemonSettings/useDaemonConnectionState.ts", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/daemon/daemonSettings/useDaemonLogDialog.ts", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/daemon/daemonSettings/useQuitOnExitSetting.ts", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/notifications/useNotificationSettingsPersistence.ts", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/notifications/useNotificationSettingsPreview.ts", phase: "D16" },
  { rule: "R15-app-from-domain", file: "domains/settings/ui/notifications/useNotificationSettingsState.ts", phase: "D16" },
  ...
  { rule: "R15-app-from-domain", file: "domains/terminal/runtime/terminalRuntimeRegistry.ts", phase: "D11" },
  { rule: "R15-app-from-domain", file: "domains/terminal/ui/TerminalView.tsx", phase: "D11" },
  { rule: "R15-app-from-domain", file: "domains/workbench/events/workbenchEventHandlers.ts", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/runtime/openTabAutoRefreshRuntime.ts", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/WorkspaceSplitPaneView.tsx", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/WorkspaceTabSurfaceLayer.tsx", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/browser/BlankView.tsx", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/browser/BrowserView.tsx", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/browser/UrlBar.tsx", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/browser/hooks/useBrowserHistory.ts", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/browser/hooks/useWebviewEvents.ts", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/browser/webviewRegistry.ts", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workbench/ui/usePaneTabHandlers.ts", phase: "D7" },
  { rule: "R15-app-from-domain", file: "domains/workspace/events/workspaceEventHandlers.ts", phase: "D8" },
  { rule: "R15-app-from-domain", file: "domains/workspace/ui/LeftPane/CreateWorkspaceDialogView.tsx", phase: "D8" },
  { rule: "R15-app-from-domain", file: "domains/workspace/ui/LeftPane/LeftPaneResourceUsageControl.tsx", phase: "D8" },
  { rule: "R15-app-from-domain", file: "domains/workspace/ui/WorkspaceResourceUsageControl.tsx", phase: "D8" },
  ...
  { rule: "R16-app-deep-into-domain", file: "app/routes/ApplicationRouterView.tsx", phase: "D17" },
  { rule: "R16-app-deep-into-domain", file: "app/routes/LoginView.tsx", phase: "D17" },
  { rule: "R16-app-deep-into-domain", file: "app/routes/OnboardOrgView.tsx", phase: "D17" },
  { rule: "R16-app-deep-into-domain", file: "app/routes/OnboardingView.tsx", phase: "D17" },
  ...
  { rule: "R16-app-deep-into-domain", file: "app/runtime/useDaemonConnectionMonitor.ts", phase: "D17" },
  ...
  { rule: "R16-app-deep-into-domain", file: "app/ui/AuthSessionExpiredSnackbar.tsx", phase: "D17" },
  { rule: "R16-app-deep-into-domain", file: "app/ui/DaemonVersionWarningControl.tsx", phase: "D17" },
