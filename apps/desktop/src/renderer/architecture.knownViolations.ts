...
export const KNOWN_VIOLATIONS: KnownViolation[] = [
  ...
  { rule: "R6-state-layer", file: "domains/overview/state/overviewStore.ts", phase: "P16" },
  { rule: "R6-state-layer", file: "domains/scheduled-job/state/scheduledJobStore.ts", phase: "P16" },
  ...
  { rule: "R6-state-layer", file: "domains/workspace/state/workspaceStoreTypes.ts", phase: "P16" },
  ...
  { rule: "R6-state-layer", file: "domains/git/state/gitProjectionStore.ts", phase: "P16" },
  // ---- R7-model-layer (Phase 16 baseline) ----
  { rule: "R7-model-layer", file: "domains/agent/model/agentChatStore.ts", phase: "P16" },
  ...
  { rule: "R7-model-layer", file: "domains/workspace/model/snapshotReconciler.ts", phase: "P16" },
