...
export const KNOWN_VIOLATIONS: KnownViolation[] = [
  ...
  { rule: "R5-cross-feature-internal", file: "features/workspace/ui/AgentChatTranscriptPane.tsx", phase: "P16" },
  ...
  { rule: "R5-cross-feature-internal", file: "features/workspace/ui/useAgentChatSessionLifecycle.ts", phase: "P16" },
  { rule: "R5-cross-feature-internal", file: "features/workspace/ui/useAgentChatSubagentActions.ts", phase: "P16" },
