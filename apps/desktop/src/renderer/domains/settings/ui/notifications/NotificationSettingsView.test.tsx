...
import { NotificationSettingsView as NotificationSettingsPanel } from "@renderer/domains/settings/ui/notifications/NotificationSettingsView";
...
vi.mock("@renderer/domains/notification/commands/notificationCommands", () => ({
