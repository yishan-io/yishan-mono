...
export { closeTerminalSession, consumeTerminalTabFocus, createTerminalSession, killTerminalProcess, listDetectedPorts, listTerminalSessions, readTerminalOutput, requestTerminalFocus, resizeTerminal, retainOpenTerminalTabFocus, setActiveWorkspace, subscribeDetectedPorts, subscribeTerminalOutput, subscribeTerminalSessions, writeTerminalInput } from "./commands/terminalCommands";
...
export { attachTerminalRuntime, detachTerminalRuntime, disposeTerminalRuntimesForClosedTabs, ensureTerminalRuntime, forceFitTerminalRuntimes, getTerminalRuntime, recoverAttachedTerminalRuntime, requestTerminalRuntimeFocus } from "./runtime/terminalRuntimeRegistry";
