...
export function useSelectedWorkspaceId() {
  ...
  console.log("[probe-hook] navStore:", workbenchNavigationStore.getState?.().activeWorkspaceId, "isMock:", (workbenchNavigationStore as unknown as { isMock?: boolean }).isMock);
