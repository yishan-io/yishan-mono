 ...
 */
export function injectSvg(container: HTMLDivElement, svgContent: string): void {
...
export type DiagramPanZoom = {
  scale: number;
  translate: { x: number; y: number };
  zoomPercent: string;
  svgCallbackRef: (node: HTMLDivElement | null) => void;
...
/** Owns the pan/zoom state and gesture handlers for the diagram overlay. */
export function useDiagramPanZoom(svgContent: string): DiagramPanZoom {
