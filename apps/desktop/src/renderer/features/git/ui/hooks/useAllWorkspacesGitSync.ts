import { createAllWorkspacesGitSyncRuntime } from "@renderer/features/git";
 ...
 * Git runtime (`allWorkspacesGitSyncRuntime.ts`); this hook only mounts the
 * runtime for the lifetime of the consuming view.
 */
